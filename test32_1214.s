...
.text
.protected Cijk_Ailk_Bljk_HSS_BH_SPA_MT16x16x64_MI16x16x1_SN_K1_MIWT1_1
.globl Cijk_Ailk_Bljk_HSS_BH_SPA_MT16x16x64_MI16x16x1_SN_K1_MIWT1_1
.p2align 8
.type Cijk_Ailk_Bljk_HSS_BH_SPA_MT16x16x64_MI16x16x1_SN_K1_MIWT1_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bljk_HSS_BH_SPA_MT16x16x64_MI16x16x1_SN_K1_MIWT1_1
  .amdhsa_user_sgpr_kernarg_segment_ptr 1
  .amdhsa_next_free_vgpr 128 // vgprs
  .amdhsa_next_free_sgpr 82 // sgprs
  .amdhsa_group_segment_fixed_size 7936 // lds bytes
...
/* VectorWidthA=1 */
/* VectorWidthB=1 */
/* GlobalReadVectorWidthA=4, GlobalReadVectorWidthB=1 */
/* DirectToLdsA=False */
/* DirectToLdsB=False */
/* UseSgprForGRO=False */
.amdgpu_metadata
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Ailk_Bljk_HSS_BH_SPA_MT16x16x64_MI16x16x1_SN_K1_MIWT1_1
    .symbol: 'Cijk_Ailk_Bljk_HSS_BH_SPA_MT16x16x64_MI16x16x1_SN_K1_MIWT1_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bljk_HSS_BH_SPA_MT16x16x64_MI16x16x1_SN_K1_MIWT1_1:
...
.set vgprGlobalReadOffsetMetadata, 87
.set vgprG2LA, 88
.set vgprG2LB, 96
...
.set sgprAddressA, 32
.set sgprAddressB, 34
.set sgprAddressMetadata, 36
.set sgprStridesD, 38
.set sgprStridesC, 40
.set sgprStridesA, 42
.set sgprStridesB, 44
.set sgprStridesMetadata, 46
.set sgprAlpha, 48
.set sgprBeta, 49
.set sgprGSU, 50
.set sgprSrdA, 52
...
.set sgprShadowLimitMetadata, 66
.set sgprStaggerUIter, 51
.set sgprWrapUA, 68
.set sgprWrapUB, 70
.set sgprWrapUMetadata, 72
...
/* type (2b): 0                           */
/******************************************/
.set Srd127_96, 0x10020000 //meng_debug
...
.macro DUMP_SGPR sgprV:req
    ...
    s_mul_i32 s[sgprWorkGroup0],s[sgprWorkGroup0] , 128
    buffer_store_b32 v16, v1, s[sgprSrdD:sgprSrdD+3], s[sgprWorkGroup0] offen offset:0
    s_waitcnt vmcnt(0)
    s_endpgm
.endm

.macro DUMP_SGPR_OFFSET sgprV:req diff:req
    s_mov_b32 s[sgprSrdD+0], s[sgprAddressD+0]         // init SRD base address (lower)
    s_mov_b32 s[sgprSrdD+1], s[sgprAddressD+1]         // init SRD base address (upper) + other fields
    s_mov_b32 s[sgprSrdD+2], 0x80000000                // 0x80000000        
    s_mov_b32 s[sgprSrdD+3], Srd127_96                 // Set bits 127_96 in post-loop SRD
    ...
    v_and_b32 v1, 31, v[vgprSerial]
    v_lshlrev_b32 v1, 2, v1
    buffer_store_b32 v16, v1, s[sgprSrdD:sgprSrdD+3], null offen offset:\diff
    s_waitcnt vmcnt(0)
    s_endpgm
.endm
...
.macro DUMP_VGPR vgprV:req
    ...
    s_and_b32       s[sgprSrdD+2],      s[sgprSrdD+2],   0xffff
    s_or_b32        s[sgprSrdD+2],      s[sgprSrdD+2],   0x00040000
    v_and_b32 v[vgprSerial], 31, v[vgprSerial]
    v_lshlrev_b32 v[vgprSerial], 2, v[vgprSerial]
    s_mul_i32 s[sgprWorkGroup0],s[sgprWorkGroup0] , 128
    buffer_store_b32 v[\vgprV], v[vgprSerial], s[sgprSrdD:sgprSrdD+3], s[sgprWorkGroup0] offen offset:0
    s_waitcnt vmcnt(0)
    s_endpgm
.endm
...
/* Load Kernel Args */
s_load_b512 s[24:39], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x0
s_load_b256 s[40:47], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x40
s_load_b64 s[48:49], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x60
s_load_b32 s50, s[sgprKernArgAddress:sgprKernArgAddress+1], 0x68
s_mov_b32 m0, 0x1f00                               // LDS clamp at 7936 bytes
...
s_waitcnt 0 //meng_debug
s_mov_b32 s[sgprWorkGroup0], ttmp9
s_mov_b32 s[sgprWorkGroup1], ttmp7
...
v_add_nc_u32 v[vgprLocalReadAddrA], v3, v[vgprLocalReadAddrA] // Final Offset: add padding 16 per block 512
...
v_add_nc_u32 v[vgprLocalReadAddrB], v2, v[vgprLocalReadAddrB] // Final Offset: add padding 16 per block 128
...
v_add_nc_u32 v[vgprLocalWriteAddrA], v6, v[vgprLocalWriteAddrA] // add padding 16 per block 512
...
v_add_nc_u32 v[vgprLocalWriteAddrB], v6, v[vgprLocalWriteAddrB] // add padding 16 per block 128
v_add_co_u32 v[vgprLocalWriteAddrB], vcc_lo, 0x500, v[vgprLocalWriteAddrB] // lwFOB = lwB1J + lwBL*MT1J + LDS_OFFSET_B=640*2
...
v_sub_nc_u32 v13, v11, v13                         // v10 = ceil(v11 / v12)
v_cmp_ne_u32 vcc_lo, v13, 0                        // v10 = ceil(v11 / v12)
v_add_co_ci_u32 v10, vcc_lo, v10, 0, vcc_lo        // ceil
...
v_sub_nc_u32 v7, s[sgprWorkGroup1], v7             // s[sgprWorkGroup1] = s[sgprWorkGroup1] / s[sgprGSU]
v_cmp_eq_u32 vcc_lo, v7, s[sgprGSU]                // s[sgprWorkGroup1] = s[sgprWorkGroup1] / s[sgprGSU]
s_mov_b32 exec_lo vcc_lo                           // s[sgprWorkGroup1] = s[sgprWorkGroup1] / s[sgprGSU]
v_add_nc_u32 v6, 1, v6                             // s[sgprWorkGroup1] = s[sgprWorkGroup1] / s[sgprGSU]
v_mov_b32 v7, 0                                    // s[sgprGSUSumIdx] = s[sgprWorkGroup1] % s[sgprGSU]
s_mov_b32 exec_lo, -1                              // s[sgprWorkGroup1] = s[sgprWorkGroup1] / s[sgprGSU]
...
s_mov_b32 exec_lo, -1                              // WGM
v_readfirstlane_b32 s78, v6
s_mul_i32 s79, s78, s[sgprWGM]                     // quotient * non-magic divisor
...
s_mul_i32 s77, s[sgprWGM], s76                     // quotient * non-magic divisor
s_sub_u32 s80, s[sgprNumWorkGroups1], s77          // WorkGroup1=remainder
s_cmp_eq_u32 s80, 0                                // remainder == 0 ?
s_cmov_b32 s80, s[sgprWGM]                         // remainder = WGM if remainder == 0
s_cmp_ge_u32 s78, s76                              // blockId >= numFullBlocks ?
s_cselect_b32 s76, s80, s[sgprWGM]
v_cvt_f32_u32 v6, s76                              // s[sgprWorkGroup0] = s79 / s76
v_rcp_iflag_f32 v6, v6                             // s[sgprWorkGroup0] = s79 / s76
v_cvt_f32_u32 v7, s79                              // s[sgprWorkGroup0] = s79 / s76
v_mul_f32 v6, v6, v7                               // s[sgprWorkGroup0] = s79 / s76
v_cvt_u32_f32 v6, v6                               // s[sgprWorkGroup0] = s79 / s76
v_mul_u32_u24 v7, v6, s76                          // s[sgprWorkGroup0] = s79 / s76
v_sub_nc_u32 v7, s79, v7                           // s[sgprWorkGroup0] = s79 / s76
v_cmp_eq_u32 vcc_lo, v7, s76                       // s[sgprWorkGroup0] = s79 / s76
s_mov_b32 exec_lo vcc_lo                           // s[sgprWorkGroup0] = s79 / s76
v_add_nc_u32 v6, 1, v6                             // s[sgprWorkGroup0] = s79 / s76
v_mov_b32 v7, 0                                    // s[sgprWorkGroup1] = s79 % s76
s_mov_b32 exec_lo, -1                              // s[sgprWorkGroup0] = s79 / s76
v_readfirstlane_b32 s[sgprWorkGroup0], v6
v_readfirstlane_b32 s[sgprWorkGroup1], v7
s_mul_i32 s78, s78, s[sgprWGM]                     // blockId * WGM
...
v_and_b32 v7, 31, v[vgprSerial]                    // 0. thread id in wave: wtid = tid % wavelength(32)
v_and_b32 v7, 15, v7                               // 1. tile offset: nIdx = wtid % MI_N(16)
v_mov_b32 v[vgprGlobalReadOffsetMetadata], v7      // 2. tile coord = tileOffset
...
v_add_co_u32 v27, vcc_lo, 8, v26                   // groAL_1 + LSPA
v_add_co_u32 v28, vcc_lo, 8, v27                   // groAL_2 + LSPA
v_add_co_u32 v29, vcc_lo, 8, v28                   // groAL_3 + LSPA

/* global read addresses: unroll offsets b */
v_mov_b32 v30, v3                                  // groBL_0
v_add_co_u32 v31, vcc_lo, 32, v30                  // groBL_1 + LSCB

/* global read addresses: shift a */
s_mul_i32 s76, s[sgprWorkGroup0], 16               // WorkGroup[01] * MT
s_sub_u32 s76, s[sgprSizeI], s76                   // edge = Size0I - WG*MT
s_sub_u32 s76, s76, 4                              // edge -= margin(4)
v_mov_b32 v7, s76                                  // edge vgpr = Size0I- WG*MT - margin(4)
v_min_i32 v6, v7, v6                               // offset = (offset < edge) ? offset(v6) : edge(v7)

/* global read addresses: shift metadata */
s_mul_i32 s76, s[sgprWorkGroup0], 16               // WorkGroup[01] * MT
s_sub_i32 s76, s[sgprSizeI], s76                   // edge = Size0I - WG*MT
s_and_b32 s77, s76, 0x3                            // edge size & (glvw-1)
s_sub_u32 s77, 0x4, s77                            // shift size = glvw - (edge size & (glvw-1))
s_andn2_b32 s76, s76, 0x3                          // edgeCoord = edge & !(glvw-1)
v_cmp_le_i32 s78, s76, v[vgprGlobalReadOffsetMetadata+0] // edgeCoord <= coord
v_sub_nc_i32 v7, v[vgprGlobalReadOffsetMetadata+0], s77 // shiftedCoord = coord - shift size
v_cndmask_b32 v[vgprGlobalReadOffsetMetadata+0], v[vgprGlobalReadOffsetMetadata+0], v7, s78 // coord =  (cond) ? shifted coord : ori coord

/* global read addresses: final offsets a */
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  6, 26, 32 // gROA_0_0_0_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+1,  6, 27, 32 // gROA_0_0_1_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+2,  6, 28, 32 // gROA_0_0_2_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+3,  6, 29, 32 // gROA_0_0_3_0
...
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0, 30, 10, 26 // gROB_0_0_0_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+1, 31, 10, 26 // gROB_1_0_0_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+2, 30, 11, 26 // gROB_0_0_1_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+3, 31, 11, 26 // gROB_1_0_1_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+4, 30, 12, 26 // gROB_0_0_2_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+5, 31, 12, 26 // gROB_1_0_2_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+6, 30, 13, 26 // gROB_0_0_3_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+7, 31, 13, 26 // gROB_1_0_3_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+8, 30, 14, 26 // gROB_0_0_4_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+9, 31, 14, 26 // gROB_1_0_4_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+10, 30, 15, 26 // gROB_0_0_5_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+11, 31, 15, 26 // gROB_1_0_5_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+12, 30, 16, 26 // gROB_0_0_6_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+13, 31, 16, 26 // gROB_1_0_6_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+14, 30, 17, 26 // gROB_0_0_7_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+15, 31, 17, 26 // gROB_1_0_7_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+16, 30, 18, 26 // gROB_0_0_8_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+17, 31, 18, 26 // gROB_1_0_8_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+18, 30, 19, 26 // gROB_0_0_9_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+19, 31, 19, 26 // gROB_1_0_9_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+20, 30, 20, 26 // gROB_0_0_10_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+21, 31, 20, 26 // gROB_1_0_10_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+22, 30, 21, 26 // gROB_0_0_11_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+23, 31, 21, 26 // gROB_1_0_11_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+24, 30, 22, 26 // gROB_0_0_12_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+25, 31, 22, 26 // gROB_1_0_12_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+26, 30, 23, 26 // gROB_0_0_13_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+27, 31, 23, 26 // gROB_1_0_13_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+28, 30, 24, 26 // gROB_0_0_14_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+29, 31, 24, 26 // gROB_1_0_14_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+30, 30, 25, 26 // gROB_0_0_15_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+31, 31, 25, 26 // gROB_1_0_15_0

/* global read addresses: addresses a */
/* max read offset = size[n] * stride[n-1] */
s_mul_hi_u32 s79, s[sgprWorkGroup0], 16            // WorkGroup[01] * MT
s_mul_i32 s78, s[sgprWorkGroup0], 16               // WorkGroup[01] * MT
s_mul_hi_u32 s77, 32, s[sgprGSUSumIdx]             // gsuOffset = DepthU/2*bpeGR*GSUSumIdx
s_mul_i32 s76, 32, s[sgprGSUSumIdx]                // gsuOffset = DepthU/2*bpeGR*GSUSumIdx
s_mul_hi_u32 s77, s76, s[sgprStrideAL]             // tlu=1, scaled unroll-offset by stride
s_mul_i32 s76, s76, s[sgprStrideAL]                // tlu=1, scaled unroll-offset by stride
s_add_u32 s78, s78, s76                            // accum GsuOffset term to tilestart
s_addc_u32 s79, s79, s77                           // accum GsuOffset term to tilestart
s_mov_b32 s[sgprShadowLimitA+0], 1                 // Init tensor size
s_mov_b32 s[sgprShadowLimitA+1], 0                 // init tensor size
s_sub_u32 s76, s[sgprSizeI], 1                     // (size-1)
s_mul_hi_u32 s77, constStrideA0I, s76              // stride x (size-1)
s_mul_i32 s76, constStrideA0I, s76                 // stride x (size-1)
s_add_u32 s[sgprShadowLimitA+0], s[sgprShadowLimitA+0], s76 // sum tensor size
s_addc_u32 s[sgprShadowLimitA+1], s[sgprShadowLimitA+1], s77 // sum tensor size
s_sub_u32 s76, s[sgprSizeL], 1                     // (size-1)
s_mul_hi_u32 s77, s[sgprStrideAL], s76             // stride x (size-1)
s_mul_i32 s76, s[sgprStrideAL], s76                // stride x (size-1)
s_add_u32 s[sgprShadowLimitA+0], s[sgprShadowLimitA+0], s76 // sum tensor size
s_addc_u32 s[sgprShadowLimitA+1], s[sgprShadowLimitA+1], s77 // sum tensor size
s_sub_u32 s[sgprShadowLimitA+0], s[sgprShadowLimitA+0], s78 // sub tileStart
s_subb_u32 s[sgprShadowLimitA+1], s[sgprShadowLimitA+1], s79 // sub tileStart
...
s_lshl_b64 s[78:79], s[78:79], 0x1                 // tileStart *= BPE
...
s_mul_hi_u32 s79, s[sgprWorkGroup0], 16            // WorkGroup[01] * MT
s_mul_i32 s78, s[sgprWorkGroup0], 16               // WorkGroup[01] * MT
s_mul_hi_u32 s79, s78, s[sgprSizeL]                // scaled tile-offset by Summation size
s_mul_i32 s78, s78, s[sgprSizeL]                   // scaled tile-offset by Summation size
s_mul_hi_u32 s77, 64, s[sgprGSUSumIdx]             // gsuOffset = DepthU*bpe*GSUSumIdx
s_mul_i32 s76, 64, s[sgprGSUSumIdx]                // gsuOffset = DepthU*bpe*GSUSumIdx
s_add_u32 s78, s78, s76                            // accum GsuOffet term to tilestart
s_addc_u32 s79, s79, s77                           // accum GsuOffet term to tilestart
s_mul_hi_u32 s81, s[sgprSizeI], s[sgprSizeL]       // calculate metadata tensor size
s_mul_i32 s80, s[sgprSizeI], s[sgprSizeL]          // calculate metadata tensor size
s_cmp_eq_u32 s[sgprStrideAK], 0                    // broadcast A?
s_cselect_b32 s81, 0x1, s[sgprSizeK]               // set batchSize as 1 for boardcast A
s_mul_hi_u32 s77, s80, s81                         // calculate metadata tensor size
s_mul_i32 s76, s80, s81                            // calculate metadata tensor size
s_cselect_b32 s81, 0x0, s[sgprWorkGroup2]          // set batchIndex as 0 for boardcast A
s_sub_u32 s[sgprShadowLimitMetadata], s76, s78     // sub tileStart
s_subb_u32 s[sgprShadowLimitMetadata+1], s77, s79  // sub tileStart
...
s_mul_hi_u32 s77, s80, s81                         // block offset*WG
s_mul_i32 s76, s80, s81                            // block offset*WG
s_add_u32 s78, s78, s76                            // accum wg term to tilestart
s_addc_u32 s79, s79, s77                           // accum wg term to tilestart
s_lshr_b64 s[78:79], s[78:79], 0x3                 // Set limit to use bytes
s_add_u32 s[sgprSrdMetadata+0], s[sgprAddressMetadata+0], s78 // SRD base = Address+ tileStart0
s_addc_u32 s[sgprSrdMetadata+1], s[sgprAddressMetadata+1], s79 // SRD base = Address+ tileStart1
s_mov_b32 s[sgprSrdMetadata+3], Srd127_96          // Set bits 127_96 in SRD

/* global read addresses: addresses b */
/* max read offset = size[n] * stride[n-1] */
s_mul_hi_u32 s79, s[sgprWorkGroup1], 16            // WorkGroup[01] * MT
s_mul_i32 s78, s[sgprWorkGroup1], 16               // WorkGroup[01] * MT
...
s_mul_hi_u32 s77, 64, s[sgprGSUSumIdx]             // gsuOffset = DepthU*bpeGR*GSUSumIdx
s_mul_i32 s76, 64, s[sgprGSUSumIdx]                // gsuOffset = DepthU*bpeGR*GSUSumIdx
s_add_u32 s78, s78, s76                            // accum GsuOffset term to tilestart
s_addc_u32 s79, s79, s77                           // accum GsuOffset term to tilestart
s_mov_b32 s[sgprShadowLimitB+0], 1                 // Init tensor size
s_mov_b32 s[sgprShadowLimitB+1], 0                 // init tensor size
s_sub_u32 s76, s[sgprSizeL], 1                     // (size-1)
s_mul_hi_u32 s77, constStrideBL, s76               // stride x (size-1)
s_mul_i32 s76, constStrideBL, s76                  // stride x (size-1)
s_add_u32 s[sgprShadowLimitB+0], s[sgprShadowLimitB+0], s76 // sum tensor size
s_addc_u32 s[sgprShadowLimitB+1], s[sgprShadowLimitB+1], s77 // sum tensor size
s_sub_u32 s76, s[sgprSizeJ], 1                     // (size-1)
s_mul_hi_u32 s77, s[sgprStrideB1J], s76            // stride x (size-1)
s_mul_i32 s76, s[sgprStrideB1J], s76               // stride x (size-1)
s_add_u32 s[sgprShadowLimitB+0], s[sgprShadowLimitB+0], s76 // sum tensor size
s_addc_u32 s[sgprShadowLimitB+1], s[sgprShadowLimitB+1], s77 // sum tensor size
s_sub_u32 s[sgprShadowLimitB+0], s[sgprShadowLimitB+0], s78 // sub tileStart
s_subb_u32 s[sgprShadowLimitB+1], s[sgprShadowLimitB+1], s79 // sub tileStart
...
s_mul_i32 s76, s[sgprGSU], DepthU*BpeAGR
s_lshr_b32 s76, s76, 0x1
s_mul_i32 s[sgprGlobalReadIncsA+0], s76, s[sgprStrideAL] // incrA unrollIdx)

/* global read addresses: increments b */
s_mul_i32 s76, s[sgprGSU], DepthU*BpeBGR
s_mov_b32 s[sgprGlobalReadIncsB+0], s76            // incrB (unrollIdx)
...
v_sub_nc_u32 v1, s[sgprLoopCounterL], v1           // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSU]
v_cmp_eq_u32 vcc_lo, v1, s[sgprGSU]                // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSU]
s_mov_b32 exec_lo vcc_lo                           // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSU]
v_add_nc_u32 v0, 1, v0                             // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSU]
v_mov_b32 v1, 0                                    // s[sgprGSUSumIdx+1] = s[sgprLoopCounterL] % s[sgprGSU]
s_mov_b32 exec_lo, -1                              // s[sgprLoopCounterL] = s[sgprLoopCounterL] / s[sgprGSU]
...
s_mov_b32 s76, 0x20                                // init staggerU
label_beginStaggerUIter:
s_lshl_b32 s77, s76, 1                             // shift by StaggerUStride
s_cmp_ge_u32 s[sgprOrigLoopCounter], s77           // loopCount >= current shift Count
s_cbranch_scc1 label_endStaggerUIter               // jump to end
s_lshr_b32 s76, s76, 1                             // step down to smaller stagger
s_branch label_beginStaggerUIter                   // jump to begin
label_endStaggerUIter:
s_sub_u32 s77, s76, 1                              // staggerU mask
s_cmp_ge_u32 s76, 1                                // if current staggerU >= 1
s_cselect_b32 s[sgprStaggerUIter], s77, 0          // set Mask
...
s_mul_i32 s78, 64, s[sgprGSU]
s_lshr_b32 s78, s78, 0x3
s_mul_hi_i32 s77, s[sgprStaggerUIter], s78         //  stagger byte offset of metadata
s_mul_i32 s76, s[sgprStaggerUIter], s78            //  stagger byte offset of metadata
s_mul_hi_i32 s[sgprWrapUMetadata+1], s[sgprLoopCounterL], s78 // Number of bytes accessed by the unroll loop
s_mul_i32 s[sgprWrapUMetadata+0], s[sgprLoopCounterL], s78 // Number of bytes accessed by the unroll loop
s_sub_u32 s[sgprWrapUMetadata+0], s78, s[sgprWrapUMetadata+0] //  remove one iteration
s_subb_u32 s[sgprWrapUMetadata+1], 0, s[sgprWrapUMetadata+1] //  remove one iteration
s_add_u32 s[sgprSrdMetadata+0], s[sgprSrdMetadata+0], s76 // gra SRD += incSparse(lower)
s_addc_u32 s[sgprSrdMetadata+1], s[sgprSrdMetadata+1], s77 // gra SRD += incSparse(uppper)
s_sub_u32 s[sgprShadowLimitMetadata+0], s[sgprShadowLimitMetadata+0], s76 // limit -= incSparse(lower)
s_subb_u32 s[sgprShadowLimitMetadata+1], s[sgprShadowLimitMetadata+1], s77 // limit -= incSparse(uppper)
s_cmp_eq_u32 s[sgprShadowLimitMetadata+1], 0       // are we within 2^32?
...
buffer_load_b64 v[vgprG2LA+2:vgprG2LA+2+1], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // G -> Reg 0_0_1_0
buffer_load_b64 v[vgprG2LA+4:vgprG2LA+4+1], v[vgprGlobalReadOffsetA+2], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // G -> Reg 0_0_2_0
buffer_load_b64 v[vgprG2LA+6:vgprG2LA+6+1], v[vgprGlobalReadOffsetA+3], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // G -> Reg 0_0_3_0
...
s_cmp_eq_u32 s[sgprShadowLimitA+1], 0              // are we within 2^32?
s_cselect_b32 s[sgprSrdA+2], s[sgprShadowLimitA+0], BufferLimit // Move shadow to real if we are within 2^32
s_mul_i32 s79, 64, s[sgprGSU]
s_lshr_b32 s79, s79, 0x3
s_cmp_eq_u32 s[sgprStaggerUIter], s78              // Is this wrapIter? (pf)
s_cselect_b32 s76, s[sgprWrapUMetadata+0], s79     // incLower <- ?
s_cselect_b32 s77, s[sgprWrapUMetadata+1], 0       // incUpper <- ?
s_add_u32 s[sgprSrdMetadata+0], s[sgprSrdMetadata+0], s76 // gra SRD += incSparse(lower)
s_addc_u32 s[sgprSrdMetadata+1], s[sgprSrdMetadata+1], s77 // gra SRD += incSparse(uppper)
s_sub_u32 s[sgprShadowLimitMetadata+0], s[sgprShadowLimitMetadata+0], s76 // limit -= incSparse(lower)
s_subb_u32 s[sgprShadowLimitMetadata+1], s[sgprShadowLimitMetadata+1], s77 // limit -= incSparse(uppper)
...
s_add_u32 s[sgprSrdC+0], s[sgprAddressC+0], s76    // add lo to SRD
s_addc_u32 s[sgprSrdC+1], s[sgprAddressC+1], s77   // add hi to SRD
...
s_add_u32 s[sgprSrdD+0], s[sgprAddressD+0], s76    // add lo to SRD
s_addc_u32 s[sgprSrdD+1], s[sgprAddressD+1], s77   // add hi to SRD
...
s_sub_u32 s80, s[sgprSizesFree+1], 1               // Free1
s_mul_i32 s80, s80, s[sgprGSUSumIdx]               // Free1
s_mul_hi_u32 s79, s80, s[sgprStrideC1J]            // Free1
s_mul_i32 s78, s80, s[sgprStrideC1J]               // Free1
s_add_u32 s76, s76, s78                            // Free1
s_addc_u32 s77, s77, s79                           // Free1
s_sub_u32 s80, s[sgprSizesFree+2], 1               // Free2
s_mul_i32 s80, s80, s[sgprGSUSumIdx]               // Free2
s_mul_hi_u32 s79, s80, s[sgprStrideCK]             // Free2
s_mul_i32 s78, s80, s[sgprStrideCK]                // Free2
...
s_cbranch_scc0 label_NoBranch_ISLQ3NYPXR61JDF0_0   // Only branch on scc1
s_getpc_b64 s[76:77]                               // addr of next instr
s_add_i32 s78, label_PrefetchGlobalLastIterEnd, 0x4 // target branch offset
...
label_NoBranch_ISLQ3NYPXR61JDF0_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+1] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+2:vgprG2LA+2+1] offset:256 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 256
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+1] offset:544 // lwoA_0_0_2_0 = (0*LSCA) + (2*LSPA)(*MT0I+PAD) = 544
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+6:vgprG2LA+6+1] offset:800 // lwoA_0_0_3_0 = (0*LSCA) + (3*LSPA)(*MT0I+PAD) = 800
...
/*  mfmaIndex:0  */
ds_load_u16 v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:544 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:576 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=1 iui=0
ds_load_u16 v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:608 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:640 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=1 iui=0
ds_load_u16 v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:672 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=4 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:704 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=5 oIdx=0 buffer=1 iui=0
ds_load_u16 v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:736 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=6 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:768 // L -> Reg lro=256 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=7 oIdx=0 buffer=1 iui=0
...
ds_load_b128 v[vgprValuB_X1_I0+4:vgprValuB_X1_I0+4+3], v[vgprLocalReadAddrB] offset:80 // L -> Reg lro=32 swapByteOffset=0 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=1 iui=0
...
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+1] offset:4096 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 4096
buffer_load_b64 v[vgprG2LA+0:vgprG2LA+0+1], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // G -> Reg 0_0_0_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(37)                                // wait for global read before writing to local
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+2:vgprG2LA+2+1] offset:4352 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 4352
buffer_load_b64 v[vgprG2LA+2:vgprG2LA+2+1], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // G -> Reg 0_0_1_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(37)                                // wait for global read before writing to local
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+1] offset:4640 // lwoA_0_0_2_0 = (0*LSCA) + (2*LSPA)(*MT0I+PAD) = 4640
buffer_load_b64 v[vgprG2LA+4:vgprG2LA+4+1], v[vgprGlobalReadOffsetA+2], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // G -> Reg 0_0_2_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(37)                                // wait for global read before writing to local
ds_store_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+6:vgprG2LA+6+1] offset:4896 // lwoA_0_0_3_0 = (0*LSCA) + (3*LSPA)(*MT0I+PAD) = 4896
buffer_load_b64 v[vgprG2LA+6:vgprG2LA+6+1], v[vgprGlobalReadOffsetA+3], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // G -> Reg 0_0_3_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(37)                                // wait for global read before writing to local
...
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+0] offset:4096 // lwoB_0_0_0_0 = (0*LSCB)*(MT1J+PAD) + (0*LSPB) = 4096
buffer_load_d16_b16 v[vgprValuMetadata+4+1], v[vgprGlobalReadOffsetMetadata+0], s[sgprSrdMetadata:sgprSrdMetadata+3], null offen offset:4 // G -> Reg ValuMetadata
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+0] offset:4160 // lwoB_1_0_0_0 = (1*LSCB)*(MT1J+PAD) + (0*LSPB) = 4160
buffer_load_d16_b16 v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_0_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+1] offset:4256 // lwoB_0_0_1_0 = (0*LSCB)*(MT1J+PAD) + (1*LSPB) = 4256
buffer_load_d16_hi_b16 v[vgprG2LB+0], v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_0_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+1] offset:4320 // lwoB_1_0_1_0 = (1*LSCB)*(MT1J+PAD) + (1*LSPB) = 4320
buffer_load_d16_b16 v[vgprG2LB+1], v[vgprGlobalReadOffsetB+2], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_1_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+2] offset:4416 // lwoB_0_0_2_0 = (0*LSCB)*(MT1J+PAD) + (2*LSPB) = 4416
buffer_load_d16_hi_b16 v[vgprG2LB+1], v[vgprGlobalReadOffsetB+3], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_1_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+2] offset:4480 // lwoB_1_0_2_0 = (1*LSCB)*(MT1J+PAD) + (2*LSPB) = 4480
buffer_load_d16_b16 v[vgprG2LB+2], v[vgprGlobalReadOffsetB+4], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_2_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+3] offset:4576 // lwoB_0_0_3_0 = (0*LSCB)*(MT1J+PAD) + (3*LSPB) = 4576
buffer_load_d16_hi_b16 v[vgprG2LB+2], v[vgprGlobalReadOffsetB+5], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_2_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+3] offset:4640 // lwoB_1_0_3_0 = (1*LSCB)*(MT1J+PAD) + (3*LSPB) = 4640
buffer_load_d16_b16 v[vgprG2LB+3], v[vgprGlobalReadOffsetB+6], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_3_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+4] offset:4736 // lwoB_0_0_4_0 = (0*LSCB)*(MT1J+PAD) + (4*LSPB) = 4736
buffer_load_d16_hi_b16 v[vgprG2LB+3], v[vgprGlobalReadOffsetB+7], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_3_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+4] offset:4800 // lwoB_1_0_4_0 = (1*LSCB)*(MT1J+PAD) + (4*LSPB) = 4800
buffer_load_d16_b16 v[vgprG2LB+4], v[vgprGlobalReadOffsetB+8], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_4_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+5] offset:4896 // lwoB_0_0_5_0 = (0*LSCB)*(MT1J+PAD) + (5*LSPB) = 4896
buffer_load_d16_hi_b16 v[vgprG2LB+4], v[vgprGlobalReadOffsetB+9], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_4_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+5] offset:4960 // lwoB_1_0_5_0 = (1*LSCB)*(MT1J+PAD) + (5*LSPB) = 4960
buffer_load_d16_b16 v[vgprG2LB+5], v[vgprGlobalReadOffsetB+10], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_5_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+6] offset:5056 // lwoB_0_0_6_0 = (0*LSCB)*(MT1J+PAD) + (6*LSPB) = 5056
buffer_load_d16_hi_b16 v[vgprG2LB+5], v[vgprGlobalReadOffsetB+11], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_5_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+6] offset:5120 // lwoB_1_0_6_0 = (1*LSCB)*(MT1J+PAD) + (6*LSPB) = 5120
buffer_load_d16_b16 v[vgprG2LB+6], v[vgprGlobalReadOffsetB+12], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_6_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+7] offset:5216 // lwoB_0_0_7_0 = (0*LSCB)*(MT1J+PAD) + (7*LSPB) = 5216
buffer_load_d16_hi_b16 v[vgprG2LB+6], v[vgprGlobalReadOffsetB+13], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_6_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+7] offset:5280 // lwoB_1_0_7_0 = (1*LSCB)*(MT1J+PAD) + (7*LSPB) = 5280
buffer_load_d16_b16 v[vgprG2LB+7], v[vgprGlobalReadOffsetB+14], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_7_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+8] offset:5376 // lwoB_0_0_8_0 = (0*LSCB)*(MT1J+PAD) + (8*LSPB) = 5376
buffer_load_d16_hi_b16 v[vgprG2LB+7], v[vgprGlobalReadOffsetB+15], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_7_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+8] offset:5440 // lwoB_1_0_8_0 = (1*LSCB)*(MT1J+PAD) + (8*LSPB) = 5440
buffer_load_d16_b16 v[vgprG2LB+8], v[vgprGlobalReadOffsetB+16], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_8_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+9] offset:5536 // lwoB_0_0_9_0 = (0*LSCB)*(MT1J+PAD) + (9*LSPB) = 5536
buffer_load_d16_hi_b16 v[vgprG2LB+8], v[vgprGlobalReadOffsetB+17], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_8_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+9] offset:5600 // lwoB_1_0_9_0 = (1*LSCB)*(MT1J+PAD) + (9*LSPB) = 5600
buffer_load_d16_b16 v[vgprG2LB+9], v[vgprGlobalReadOffsetB+18], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_9_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+10] offset:5696 // lwoB_0_0_10_0 = (0*LSCB)*(MT1J+PAD) + (10*LSPB) = 5696
buffer_load_d16_hi_b16 v[vgprG2LB+9], v[vgprGlobalReadOffsetB+19], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_9_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+10] offset:5760 // lwoB_1_0_10_0 = (1*LSCB)*(MT1J+PAD) + (10*LSPB) = 5760
buffer_load_d16_b16 v[vgprG2LB+10], v[vgprGlobalReadOffsetB+20], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_10_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+11] offset:5856 // lwoB_0_0_11_0 = (0*LSCB)*(MT1J+PAD) + (11*LSPB) = 5856
buffer_load_d16_hi_b16 v[vgprG2LB+10], v[vgprGlobalReadOffsetB+21], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_10_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+11] offset:5920 // lwoB_1_0_11_0 = (1*LSCB)*(MT1J+PAD) + (11*LSPB) = 5920
buffer_load_d16_b16 v[vgprG2LB+11], v[vgprGlobalReadOffsetB+22], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_11_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+12] offset:6016 // lwoB_0_0_12_0 = (0*LSCB)*(MT1J+PAD) + (12*LSPB) = 6016
buffer_load_d16_hi_b16 v[vgprG2LB+11], v[vgprGlobalReadOffsetB+23], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_11_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+12] offset:6080 // lwoB_1_0_12_0 = (1*LSCB)*(MT1J+PAD) + (12*LSPB) = 6080
buffer_load_d16_b16 v[vgprG2LB+12], v[vgprGlobalReadOffsetB+24], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_12_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+13] offset:6176 // lwoB_0_0_13_0 = (0*LSCB)*(MT1J+PAD) + (13*LSPB) = 6176
buffer_load_d16_hi_b16 v[vgprG2LB+12], v[vgprGlobalReadOffsetB+25], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_12_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+13] offset:6240 // lwoB_1_0_13_0 = (1*LSCB)*(MT1J+PAD) + (13*LSPB) = 6240
buffer_load_d16_b16 v[vgprG2LB+13], v[vgprGlobalReadOffsetB+26], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_13_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+14] offset:6336 // lwoB_0_0_14_0 = (0*LSCB)*(MT1J+PAD) + (14*LSPB) = 6336
buffer_load_d16_hi_b16 v[vgprG2LB+13], v[vgprGlobalReadOffsetB+27], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_13_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+14] offset:6400 // lwoB_1_0_14_0 = (1*LSCB)*(MT1J+PAD) + (14*LSPB) = 6400
buffer_load_d16_b16 v[vgprG2LB+14], v[vgprGlobalReadOffsetB+28], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_14_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16 v[vgprLocalWriteAddrB], v[vgprG2LB+15] offset:6496 // lwoB_0_0_15_0 = (0*LSCB)*(MT1J+PAD) + (15*LSPB) = 6496
buffer_load_d16_hi_b16 v[vgprG2LB+14], v[vgprGlobalReadOffsetB+29], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_14_0
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(36)                                // wait for global read before writing to local
ds_store_b16_d16_hi v[vgprLocalWriteAddrB], v[vgprG2LB+15] offset:6560 // lwoB_1_0_15_0 = (1*LSCB)*(MT1J+PAD) + (15*LSPB) = 6560
buffer_load_d16_b16 v[vgprG2LB+15], v[vgprGlobalReadOffsetB+30], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 0_0_15_0
buffer_load_d16_hi_b16 v[vgprG2LB+15], v[vgprGlobalReadOffsetB+31], s[sgprSrdB:sgprSrdB+3], null offen offset:0 // G -> Reg 1_0_15_0
...
/* localReadInitPointers */
s_waitcnt lgkmcnt(15)                              // wait for prior local read local write old=0, new=46 newLW=36 newLR=10
...
// Skip barrier: NumThreads=32
ds_load_u16 v[vgprValuA_X0_I0+0], v[vgprLocalReadAddrA] offset:4096 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_load_u16_d16_hi v[vgprValuA_X0_I0+0], v[vgprLocalReadAddrA] offset:4128 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=0 iui=0
ds_load_u16 v[vgprValuA_X0_I0+1], v[vgprLocalReadAddrA] offset:4160 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=0 iui=0
ds_load_u16_d16_hi v[vgprValuA_X0_I0+1], v[vgprLocalReadAddrA] offset:4192 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=0 iui=0
ds_load_u16 v[vgprValuA_X0_I0+2], v[vgprLocalReadAddrA] offset:4224 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=4 oIdx=0 buffer=0 iui=0
ds_load_u16_d16_hi v[vgprValuA_X0_I0+2], v[vgprLocalReadAddrA] offset:4256 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=5 oIdx=0 buffer=0 iui=0
ds_load_u16 v[vgprValuA_X0_I0+3], v[vgprLocalReadAddrA] offset:4288 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=6 oIdx=0 buffer=0 iui=0
ds_load_u16_d16_hi v[vgprValuA_X0_I0+3], v[vgprLocalReadAddrA] offset:4320 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=7 oIdx=0 buffer=0 iui=0
ds_load_b128 v[vgprValuB_X0_I0+0:vgprValuB_X0_I0+0+3], v[vgprLocalReadAddrB] offset:4096 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
ds_load_b128 v[vgprValuB_X0_I0+4:vgprValuB_X0_I0+4+3], v[vgprLocalReadAddrB] offset:4112 // L -> Reg lro=0 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=0 iui=0
s_waitcnt lgkmcnt(15)                              // wait for prior local read local write old=0, new=46 newLW=36 newLR=10
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:1  */
/*  mfmaIndex:0  */
ds_load_u16 v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:4640 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+0], v[vgprLocalReadAddrA] offset:4672 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=1 iui=0
ds_load_u16 v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:4704 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+1], v[vgprLocalReadAddrA] offset:4736 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=1 iui=0
ds_load_u16 v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:4768 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=4 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+2], v[vgprLocalReadAddrA] offset:4800 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=5 oIdx=0 buffer=1 iui=0
ds_load_u16 v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:4832 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=6 oIdx=0 buffer=1 iui=0
ds_load_u16_d16_hi v[vgprValuA_X1_I0+3], v[vgprLocalReadAddrA] offset:4864 // L -> Reg lro=256 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=7 oIdx=0 buffer=1 iui=0
ds_load_b128 v[vgprValuB_X1_I0+0:vgprValuB_X1_I0+0+3], v[vgprLocalReadAddrB] offset:4160 // L -> Reg lro=32 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=1 iui=0
ds_load_b128 v[vgprValuB_X1_I0+4:vgprValuB_X1_I0+4+3], v[vgprLocalReadAddrB] offset:4176 // L -> Reg lro=32 swapByteOffset=4096 ti=16 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=1 iui=0
...
/******************************************/
s_mov_b32 s5, 0x0
s_cmp_eq_u32 s[sgprBeta], s5                       // Beta == 0
...
/* endSummation: add vgpr [10...114) to pool */
/* load store sgprs */
...
v_lshlrev_b32 v10, 0x3, v10                        // thread0 * continuous_output
v_add_lshl_u32 v10, v15, v10, 0                    // coordination 0 = vwA *(wave_id0 + tid0)
s_mul_i32 s5, 16, s[sgprWorkGroup0]                // wgp0 * MT0
v_add_nc_u32 v10, s5, v10                          // coord 0 = (tid0/MI_m)*4 + waveG0*MIB_m + MT0*SG0
s_mul_i32 s5, 16, s[sgprWorkGroup1]                // wgp1 * MT1
v_add_nc_u32 v11, s5, v11                          // coord 1 = (tid0%MI_m) + waveG1*MIB_n + MT1*SG1
...
buffer_store_b128 v[24:27], v16, s[sgprSrdD:sgprSrdD+3], null offen offset:0 // store D
buffer_store_b128 v[28:31], v16, s[sgprSrdD:sgprSrdD+3], null offen offset:16 // store D
...
s_lshr_b32 s78, s78, 0x3
s_sub_i32 s76, 3, s[sgprStaggerUIter]
s_mul_hi_i32 s77, s76, s78                         // start offset S in bytes
s_mul_i32 s76, s76, s78                            // start offset S in bytes
s_sub_u32 s76, s76, s[sgprWrapUMetadata]           // S - WrapU
s_subb_u32 s77, s77, s[sgprWrapUMetadata+1]        // S - WrapU
s_add_u32 s[sgprSrdMetadata+0], s[sgprSrdMetadata+0], s76 // gra SRD += incSparse(lower)
s_addc_u32 s[sgprSrdMetadata+1], s[sgprSrdMetadata+1], s77 // gra SRD += incSparse(uppper)
s_sub_u32 s[sgprShadowLimitMetadata+0], s[sgprShadowLimitMetadata+0], s76 // limit -= incSparse(lower)
s_subb_u32 s[sgprShadowLimitMetadata+1], s[sgprShadowLimitMetadata+1], s77 // limit -= incSparse(uppper)
...
buffer_load_b32 v[vgprG2LA+0+1], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], null offen offset:4 // load packed 2X half buffer value
/* g2l=2, load component 0 */
buffer_load_b32 v[vgprG2LA+2+0], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // load packed 2X half buffer value
/* g2l=2, load component 2 */
buffer_load_b32 v[vgprG2LA+2+1], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], null offen offset:4 // load packed 2X half buffer value
/* g2l=4, load component 0 */
buffer_load_b32 v[vgprG2LA+4+0], v[vgprGlobalReadOffsetA+2], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // load packed 2X half buffer value
/* g2l=4, load component 2 */
buffer_load_b32 v[vgprG2LA+4+1], v[vgprGlobalReadOffsetA+2], s[sgprSrdA:sgprSrdA+3], null offen offset:4 // load packed 2X half buffer value
/* g2l=6, load component 0 */
buffer_load_b32 v[vgprG2LA+6+0], v[vgprGlobalReadOffsetA+3], s[sgprSrdA:sgprSrdA+3], null offen offset:0 // load packed 2X half buffer value
/* g2l=6, load component 2 */
buffer_load_b32 v[vgprG2LA+6+1], v[vgprGlobalReadOffsetA+3], s[sgprSrdA:sgprSrdA+3], null offen offset:4 // load packed 2X half buffer value
...
/* Tail: add address/G2L vgpr [49...114) to pool */
...
/* local read inc a */
s_mov_b32 s5, 0x220                                // inc
v_add_co_u32 v[vgprLocalReadAddrA], vcc_lo, s5, v[vgprLocalReadAddrA] // lrA += 544 (LSU*(MT+PAD)*bpe)

/* local read inc b */
s_mov_b32 s5, 0x40                                 // inc
v_add_co_u32 v[vgprLocalReadAddrB], vcc_lo, s5, v[vgprLocalReadAddrB] // lrB += 64 (LSU*bpe)
s_waitcnt lgkmcnt(0)                               // 4wait for local read
s_sub_i32 s76, s[sgprLoopCounterL], 1              // calculate 64bit groups index
s_lshr_b32 s77, s76, 2                             // calculate 64bit groups index
s_and_b32 s76, s76, 3                              // calculate shift value
s_sub_i32 s76, 3, s76                              // calculate shift value
s_lshl_b32 s76, s76, 4                             // calculate shift value
v_cmp_eq_i32 s78, s77, 0                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+0:vgprValuA_X0_I0+0+0+1] // shfit for ValuA[0:1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0], v[vgprValuA_X0_I0+0+0+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+1], v[vgprValuA_X0_I0+0+0+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+0:vgprValuB_X0_I0+0+0+1] // shfit for ValuB[0:1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0], v[vgprValuB_X0_I0+0+0+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+1], v[vgprValuB_X0_I0+0+0+1], v51, s78 // shift if in this 64b group
v_cmp_eq_i32 s78, s77, 1                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+2:vgprValuA_X0_I0+0+2+1] // shfit for ValuA[2:3]
v_cndmask_b32 v[vgprValuA_X0_I0+0+2+0], v[vgprValuA_X0_I0+0+2+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+2+1], v[vgprValuA_X0_I0+0+2+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+2:vgprValuB_X0_I0+0+2+1] // shfit for ValuB[2:3]
v_cndmask_b32 v[vgprValuB_X0_I0+0+2+0], v[vgprValuB_X0_I0+0+2+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+2+1], v[vgprValuB_X0_I0+0+2+1], v51, s78 // shift if in this 64b group
v_cmp_lt_i32 s78, s77, 1                           // handle this 64bit group: part 2
v_cndmask_b32 v[vgprValuA_X0_I0+0+2+0], v[vgprValuA_X0_I0+0+2+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+2+1], v[vgprValuA_X0_I0+0+2+1], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+2+0], v[vgprValuB_X0_I0+0+2+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+2+1], v[vgprValuB_X0_I0+0+2+1], 0, s78 // shift if in this 64b group
v_cmp_eq_i32 s78, s77, 2                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+4:vgprValuA_X0_I0+0+4+1] // shfit for ValuA[4:5]
v_cndmask_b32 v[vgprValuA_X0_I0+0+4+0], v[vgprValuA_X0_I0+0+4+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+4+1], v[vgprValuA_X0_I0+0+4+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+4:vgprValuB_X0_I0+0+4+1] // shfit for ValuB[4:5]
v_cndmask_b32 v[vgprValuB_X0_I0+0+4+0], v[vgprValuB_X0_I0+0+4+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+4+1], v[vgprValuB_X0_I0+0+4+1], v51, s78 // shift if in this 64b group
v_cmp_lt_i32 s78, s77, 2                           // handle this 64bit group: part 2
v_cndmask_b32 v[vgprValuA_X0_I0+0+4+0], v[vgprValuA_X0_I0+0+4+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+4+1], v[vgprValuA_X0_I0+0+4+1], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+4+0], v[vgprValuB_X0_I0+0+4+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+4+1], v[vgprValuB_X0_I0+0+4+1], 0, s78 // shift if in this 64b group
v_cmp_eq_i32 s78, s77, 3                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+6:vgprValuA_X0_I0+0+6+1] // shfit for ValuA[6:7]
v_cndmask_b32 v[vgprValuA_X0_I0+0+6+0], v[vgprValuA_X0_I0+0+6+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+6+1], v[vgprValuA_X0_I0+0+6+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+6:vgprValuB_X0_I0+0+6+1] // shfit for ValuB[6:7]
v_cndmask_b32 v[vgprValuB_X0_I0+0+6+0], v[vgprValuB_X0_I0+0+6+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+6+1], v[vgprValuB_X0_I0+0+6+1], v51, s78 // shift if in this 64b group
v_cmp_lt_i32 s78, s77, 3                           // handle this 64bit group: part 2
v_cndmask_b32 v[vgprValuA_X0_I0+0+6+0], v[vgprValuA_X0_I0+0+6+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+6+1], v[vgprValuA_X0_I0+0+6+1], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+6+0], v[vgprValuB_X0_I0+0+6+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+6+1], v[vgprValuB_X0_I0+0+6+1], 0, s78 // shift if in this 64b group
v_cmp_eq_i32 s78, s77, 4                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+8:vgprValuA_X0_I0+0+8+1] // shfit for ValuA[8:9]
v_cndmask_b32 v[vgprValuA_X0_I0+0+8+0], v[vgprValuA_X0_I0+0+8+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+8+1], v[vgprValuA_X0_I0+0+8+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+8:vgprValuB_X0_I0+0+8+1] // shfit for ValuB[8:9]
v_cndmask_b32 v[vgprValuB_X0_I0+0+8+0], v[vgprValuB_X0_I0+0+8+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+8+1], v[vgprValuB_X0_I0+0+8+1], v51, s78 // shift if in this 64b group
v_cmp_lt_i32 s78, s77, 4                           // handle this 64bit group: part 2
v_cndmask_b32 v[vgprValuA_X0_I0+0+8+0], v[vgprValuA_X0_I0+0+8+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+8+1], v[vgprValuA_X0_I0+0+8+1], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+8+0], v[vgprValuB_X0_I0+0+8+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+8+1], v[vgprValuB_X0_I0+0+8+1], 0, s78 // shift if in this 64b group
v_cmp_eq_i32 s78, s77, 5                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+10:vgprValuA_X0_I0+0+10+1] // shfit for ValuA[10:11]
v_cndmask_b32 v[vgprValuA_X0_I0+0+10+0], v[vgprValuA_X0_I0+0+10+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+10+1], v[vgprValuA_X0_I0+0+10+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+10:vgprValuB_X0_I0+0+10+1] // shfit for ValuB[10:11]
v_cndmask_b32 v[vgprValuB_X0_I0+0+10+0], v[vgprValuB_X0_I0+0+10+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+10+1], v[vgprValuB_X0_I0+0+10+1], v51, s78 // shift if in this 64b group
v_cmp_lt_i32 s78, s77, 5                           // handle this 64bit group: part 2
v_cndmask_b32 v[vgprValuA_X0_I0+0+10+0], v[vgprValuA_X0_I0+0+10+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+10+1], v[vgprValuA_X0_I0+0+10+1], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+10+0], v[vgprValuB_X0_I0+0+10+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+10+1], v[vgprValuB_X0_I0+0+10+1], 0, s78 // shift if in this 64b group
v_cmp_eq_i32 s78, s77, 6                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+12:vgprValuA_X0_I0+0+12+1] // shfit for ValuA[12:13]
v_cndmask_b32 v[vgprValuA_X0_I0+0+12+0], v[vgprValuA_X0_I0+0+12+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+12+1], v[vgprValuA_X0_I0+0+12+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+12:vgprValuB_X0_I0+0+12+1] // shfit for ValuB[12:13]
v_cndmask_b32 v[vgprValuB_X0_I0+0+12+0], v[vgprValuB_X0_I0+0+12+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+12+1], v[vgprValuB_X0_I0+0+12+1], v51, s78 // shift if in this 64b group
v_cmp_lt_i32 s78, s77, 6                           // handle this 64bit group: part 2
v_cndmask_b32 v[vgprValuA_X0_I0+0+12+0], v[vgprValuA_X0_I0+0+12+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+12+1], v[vgprValuA_X0_I0+0+12+1], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+12+0], v[vgprValuB_X0_I0+0+12+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+12+1], v[vgprValuB_X0_I0+0+12+1], 0, s78 // shift if in this 64b group
v_cmp_eq_i32 s78, s77, 7                           // handle this 64bit group: part 1
v_lshlrev_b64 v[50:51], s76, v[vgprValuA_X0_I0+0+14:vgprValuA_X0_I0+0+14+1] // shfit for ValuA[14:15]
v_cndmask_b32 v[vgprValuA_X0_I0+0+14+0], v[vgprValuA_X0_I0+0+14+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+14+1], v[vgprValuA_X0_I0+0+14+1], v51, s78 // shift if in this 64b group
v_lshlrev_b64 v[50:51], s76, v[vgprValuB_X0_I0+0+14:vgprValuB_X0_I0+0+14+1] // shfit for ValuB[14:15]
v_cndmask_b32 v[vgprValuB_X0_I0+0+14+0], v[vgprValuB_X0_I0+0+14+0], v50, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+14+1], v[vgprValuB_X0_I0+0+14+1], v51, s78 // shift if in this 64b group
v_cmp_lt_i32 s78, s77, 7                           // handle this 64bit group: part 2
v_cndmask_b32 v[vgprValuA_X0_I0+0+14+0], v[vgprValuA_X0_I0+0+14+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuA_X0_I0+0+14+1], v[vgprValuA_X0_I0+0+14+1], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+14+0], v[vgprValuB_X0_I0+0+14+0], 0, s78 // shift if in this 64b group
v_cndmask_b32 v[vgprValuB_X0_I0+0+14+1], v[vgprValuB_X0_I0+0+14+1], 0, s78 // shift if in this 64b group
s_nop 1
v_swmmac_f32_16x16x32_f16 v[0:7], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+3], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+7], v[vgprValuMetadata+0] // left value = v[0+0:7+0]
...
/* Tail: remove address/G2L [49...114) from pool */
label_Summation_End_2KAB63JIENMDF4HA_0:
/* endSummation: add vgpr [10...114) to pool */
...
v_cmp_lt_u32 s5, v13, v14                          // wgMT < MT
v_cndmask_b32 v13, v14, v13, s5                    // wgMT = (wgMT < MT) ? wgMT : MT
...
s_mov_b32 s5, 0
v_cmp_eq_u32 s5, v16, s5                           // is thread in edge glvw region
s_mov_b32 exec_lo s5                               // is thread in edge glvw region
v_and_b32 v10, 31, v[vgprSerial]                   // permute register between threads
v_lshlrev_b32 v10, 2, v10                          // permute register between threads
v_mov_b32 v17, v3                                  // glvw 1 mb 0 tt1 0 r 0
v_mov_b32 v0, v17
s_mov_b32 s5, 0xFFFFFFFF                           // to restore all threads active
s_or_saveexec_b32 vcc_lo, s5                       // all threads active
...
v_and_b32 v10, 31, v[vgprSerial]                   // permute register between threads
v_lshlrev_b32 v10, 2, v10                          // permute register between threads
v_mov_b32 v17, v7                                  // glvw 1 mb 0 tt1 0 r 0
v_mov_b32 v4, v17
s_mov_b32 s5, 0xFFFFFFFF                           // to restore all threads active
s_or_saveexec_b32 vcc_lo, s5                       // all threads active
s_branch label_ShiftVectorComponents0_GLVW0_0      // done shifting
...
v_and_b32 v10, 31, v[vgprSerial]                   // permute register between threads
v_lshlrev_b32 v10, 2, v10                          // permute register between threads
v_mov_b32 v17, v2                                  // glvw 2 mb 0 tt1 0 r 0
v_mov_b32 v18, v3                                  // glvw 2 mb 0 tt1 0 r 0
v_mov_b32 v0, v17
v_mov_b32 v1, v18
s_mov_b32 s5, 0xFFFFFFFF                           // to restore all threads active
s_or_saveexec_b32 vcc_lo, s5                       // all threads active
...
v_and_b32 v10, 31, v[vgprSerial]                   // permute register between threads
v_lshlrev_b32 v10, 2, v10                          // permute register between threads
v_mov_b32 v17, v6                                  // glvw 2 mb 0 tt1 0 r 0
v_mov_b32 v18, v7                                  // glvw 2 mb 0 tt1 0 r 0
v_mov_b32 v4, v17
v_mov_b32 v5, v18
s_mov_b32 s5, 0xFFFFFFFF                           // to restore all threads active
s_or_saveexec_b32 vcc_lo, s5                       // all threads active
...
v_and_b32 v10, 31, v[vgprSerial]                   // permute register between threads
v_lshlrev_b32 v10, 2, v10                          // permute register between threads
v_mov_b32 v17, v1                                  // glvw 3 mb 0 tt1 0 r 0
v_mov_b32 v18, v2                                  // glvw 3 mb 0 tt1 0 r 0
v_mov_b32 v19, v3                                  // glvw 3 mb 0 tt1 0 r 0
v_mov_b32 v0, v17
v_mov_b32 v1, v18
v_mov_b32 v2, v19
s_mov_b32 s5, 0xFFFFFFFF                           // to restore all threads active
...
v_and_b32 v10, 31, v[vgprSerial]                   // permute register between threads
v_lshlrev_b32 v10, 2, v10                          // permute register between threads
v_mov_b32 v17, v5                                  // glvw 3 mb 0 tt1 0 r 0
v_mov_b32 v18, v6                                  // glvw 3 mb 0 tt1 0 r 0
v_mov_b32 v19, v7                                  // glvw 3 mb 0 tt1 0 r 0
v_mov_b32 v4, v17
v_mov_b32 v5, v18
v_mov_b32 v6, v19
s_mov_b32 s5, 0xFFFFFFFF                           // to restore all threads active
...
/* (d1,vc1,d0,vc0)=(0,0,0,0) */
v_cmp_lt_u32 s52, v10, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s54, s52, s54                            // in0 && in1
v_add_lshl_u32 v16, v13, v10, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v16, v32, v16, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,1) */
v_add_co_u32 v14, vcc_lo, v10, 1                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s54, s52, s54                            // in0 && in1
v_add_lshl_u32 v18, v13, v14, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v18, v32, v18, s54                   // LDD clip if OOB. offset
...
v_cndmask_b32 v20, v32, v20, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,3) */
v_add_co_u32 v14, vcc_lo, v10, 3                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s54, s52, s54                            // in0 && in1
v_add_lshl_u32 v22, v13, v14, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v22, v32, v22, s54                   // LDD clip if OOB. offset
...
v_cndmask_b32 v24, v32, v24, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,5) */
v_add_co_u32 v14, vcc_lo, v10, 5                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s54, s52, s54                            // in0 && in1
v_add_lshl_u32 v26, v13, v14, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v26, v32, v26, s54                   // LDD clip if OOB. offset
...
v_cndmask_b32 v28, v32, v28, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,7) */
v_add_co_u32 v14, vcc_lo, v10, 7                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
s_and_b32 s54, s52, s54                            // in0 && in1
v_add_lshl_u32 v30, v13, v14, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v30, v32, v30, s54                   // LDD clip if OOB. offset
...
v_mov_b32 v[vgprValuC+19], v[vgprValuC+1]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+21], v[vgprValuC+2]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+23], v[vgprValuC+3]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+25], v[vgprValuC+4]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+27], v[vgprValuC+5]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+29], v[vgprValuC+6]          // Rearrange MI out reg
v_mov_b32 v[vgprValuC+31], v[vgprValuC+7]          // Rearrange MI out reg
...
label_GSU_4:
s_mov_b32 s51, 0x0
s_cmp_eq_u32 s[sgprBeta], s51                      // Beta == 0
...
buffer_load_b128 v[24:27], v17, s[sgprSrdC:sgprSrdC+3], null offen offset:0 // load C
buffer_load_b128 v[28:31], v17, s[sgprSrdC:sgprSrdC+3], null offen offset:16 // load C
v_add_lshl_u32 v16, v13, v10, 0x2                  // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=10, coord0Vgpr=10

/* rC *= alpha batchElements=[(0, 0, 0, 0)] */
v_mul_f32 v[vgprValuC+32], s[sgprAlpha], v[vgprValuC+0] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+33], s[sgprAlpha], v[vgprValuC+1] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+34], s[sgprAlpha], v[vgprValuC+2] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+35], s[sgprAlpha], v[vgprValuC+3] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+36], s[sgprAlpha], v[vgprValuC+4] // Multiply MI out reg with alpha
v_mul_f32 v[vgprValuC+37], s[sgprAlpha], v[vgprValuC+5] // Multiply MI out reg with alpha
...
s_waitcnt vmcnt(0)                                 // vmcnt(0) = 2 - 2 (beta) (interleaved)
v_fmac_f32 v[vgprValuC+32], v24, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+33], v25, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+34], v26, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+35], v27, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+36], v28, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+37], v29, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+38], v30, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+39], v31, s[sgprBeta]       // finalSum = sum*alpha + C*beta
buffer_store_b128 v[32:35], v16, s[sgprSrdD:sgprSrdD+3], null offen offset:0 // store D
buffer_store_b128 v[36:39], v16, s[sgprSrdD:sgprSrdD+3], null offen offset:16 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_2                            // jump to end
label_GW_B1_E1:
...
v_cndmask_b32 v16, v40, v16, s54                   // LDC clip if OOB. offset
buffer_load_b32 v17, v16, s[sgprSrdC:sgprSrdC+3], null offen offset:0 // load C
v_add_lshl_u32 v16, v13, v10, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v16, v40, v16, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,1) */
v_add_co_u32 v14, vcc_lo, v10, 1                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
...
v_cndmask_b32 v19, v40, v19, s54                   // LDC clip if OOB. offset
...
v_cndmask_b32 v19, v40, v19, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,2) */
v_add_co_u32 v14, vcc_lo, v10, 2                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
...
v_cndmask_b32 v22, v40, v22, s54                   // LDC clip if OOB. offset
buffer_load_b32 v23, v22, s[sgprSrdC:sgprSrdC+3], null offen offset:0 // load C
v_add_lshl_u32 v22, v13, v14, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v22, v40, v22, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,3) */
v_add_co_u32 v14, vcc_lo, v10, 3                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
...
v_cndmask_b32 v25, v40, v25, s54                   // LDC clip if OOB. offset
...
v_cndmask_b32 v25, v40, v25, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,4) */
v_add_co_u32 v14, vcc_lo, v10, 4                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
...
v_cndmask_b32 v28, v40, v28, s54                   // LDC clip if OOB. offset
buffer_load_b32 v29, v28, s[sgprSrdC:sgprSrdC+3], null offen offset:0 // load C
v_add_lshl_u32 v28, v13, v14, 0x2                  // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v28, v40, v28, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,5) */
v_add_co_u32 v14, vcc_lo, v10, 5                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
...
v_cndmask_b32 v31, v40, v31, s54                   // LDC clip if OOB. offset
...
v_cndmask_b32 v31, v40, v31, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,6) */
v_add_co_u32 v14, vcc_lo, v10, 6                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
...
v_cndmask_b32 v34, v40, v34, s54                   // LDC clip if OOB. offset
...
v_cndmask_b32 v34, v40, v34, s54                   // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,7) */
v_add_co_u32 v14, vcc_lo, v10, 7                   // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s52, v14, s[sgprSizeI]                // coord0 < size0
v_cmp_lt_u32 s54, v11, s[sgprSizeJ]                // coord1 < size1
...
v_cndmask_b32 v37, v40, v37, s54                   // LDC clip if OOB. offset
...
v_cndmask_b32 v37, v40, v37, s54                   // LDD clip if OOB. offset
